...
public class AppJwtUtil {
    ...
    private static final String SECRET = "hailiao-im-app-jwt-secret-key-for-jwt-token-generation-2024";
    ...
    public String generateToken(Long userId, String username, Integer type) {
        return generateToken(userId, username, type, null);
    }

    public String generateToken(Long userId, String username, Integer type, String sessionId) {
